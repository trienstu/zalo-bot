...
async function handleHistoryQA(
  ...
  const systemPrompt =
    ...
    `- CẬP NHẬT DỮ KIỆN HÀNH CHÍNH & SỰ KIỆN PHÁP LUẬT MỚI: BẮT BUỘC ưu tiên dữ liệu mới nhất từ phần 'DỮ LIỆU THỜI GIAN THỰC & BÁCH KHOA MỚI NHẤT', không bám vào số liệu cũ trong trí nhớ đã lỗi thời (ví dụ: Thành phố Huế đã chính thức là Thành phố trực thuộc Trung ương từ 01/01/2025 theo Nghị quyết 175/2024/QH15 của Quốc hội; các nghị quyết sáp nhập/sắp xếp đơn vị hành chính mới). Phải giải thích rõ ràng và cập nhật số liệu mới nhất cho người hỏi!\n` +
